...
sub check_avc {
    ...
    $instance->run_ssh_command(cmd => 'ls -laZ /run/');
    $instance->run_ssh_command(cmd => 'ls -Z $(which netconfig)');
...
sub run {
    ...
    $instance->softreboot();
    $instance->run_ssh_command(cmd => 'systemctl status wicked.service');
    $instance->run_ssh_command(cmd => 'systemctl status NetworkManager.service');
    $instance->run_ssh_command(cmd => 'zypper info wicked');
    $instance->run_ssh_command(cmd => 'zypper info NetworkManager');
    #instance->run_ssh_command(cmd => 'sudo transactional-update -n pkg remove wicked wicked-service');
    $instance->run_ssh_command(cmd => 'systemctl stop NetworkManager.service');
    $instance->run_ssh_command(cmd => 'systemctl disable NetworkManager.service');
    $instance->run_ssh_command(cmd => 'systemctl status NetworkManager.service');
    #instance->softreboot();
