...
sub run {
    ...
    if (is_sle) {
        ...
        elsif (is_sle('=15-SP7') || $sp_version == '15.7') {
		...
		#zypper_call("ar -f --no-gpgcheck http://download.suse.de/ibs/SUSE:/Velociraptor/SLE_15_SP4/ sensor");
            zypper_call("ar -f --no-gpgcheck https://download.opensuse.org/repositories/home:/doreilly:/branches:/security:/sensor/SLE_15_SP4/ sensor");
        }
